...
const ModalInfo = ({ isVisible, toggle }) => {
    return (
        ...
        <div className='ModalInfo'>
            ...
            <p>این برنامه به صورت PWA <a rel="noreferrer" href='https://github.com/Sadegh-Zr/fallacies' target='_blank'>توسعه داده شده است</a>؛ بنابراین می‌توانید به راحتی آن را نصب کرده و به شکل آفلاین از آن استفاده کنید.</p>
            <p>برای نظرات، پیشنهادات و انتقادات، می‌توانید از طریق <a rel="noreferrer" href='mailto:sadegh.zarinmehr@gmail.com' target='_blank'>ایمیل</a> و <a rel="noreferrer" href='https://eitaa.com/sadegh_zr' target='_blank'>پیامبرسان ایتا</a> با من در ارتباط باشید.</p>
