...
const ModalInfo = ({ isVisible, toggle }) => {
    return (
        ...
        <div className='ModalInfo'>
            ...
            <p>با سلام! این برنامه را با توجه به کتاب «مغالطات» دکتر علی اصغر خندان طراحی کردم. علاوه بر استفاده از مثال‌ها و سؤالات خود کتاب که با توجه به آنچه صلاح به نظر می‌رسید، تغییراتی در برخی از آن‌ها دادم، بعضی مثال‌ها و سؤالات را نیز به محتوا افزود. امیدوارم که این مجموعه مورد رضایت امام زمان -عجل الله تعالی فرجه الشریف- قرار بگیرد.</p>
